        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InviteUsers_AspNetUsers_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InviteUsers_AspNetUsers_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InviteUsers_Workspaces_WorkspaceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkspaceId = table.Column<int>(type: "int", nullable: false),
                    TaskCreatorId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InviteUsers_FromUserId",
                table: "InviteUsers",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_InviteUsers_ToUserId",
                table: "InviteUsers",
                column: "ToUserId");

            migrationBuilder.CreateIndex(
                name: "IX_InviteUsers_WorkspaceId",
                table: "InviteUsers",
                column: "WorkspaceId");
